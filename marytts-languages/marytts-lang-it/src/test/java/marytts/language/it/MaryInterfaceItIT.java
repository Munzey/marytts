 ...
 *
 */
public class MaryInterfaceItIT {
	...
	public void convertTextToTargetfeatures() throws Exception {
		...
		String tf = mary.generateText("Benvenuto nel mondo della sintesi vocale.");
		assertNotNull(tf);
	}
